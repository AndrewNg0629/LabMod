...
public class LoginModIdRequestS2CPayload implements MythicLoginS2CPayload {
    public static final Identifier ID = Identifier.of("labmod", "mod_id_req_s2c");
    public static final PacketCodec<PacketByteBuf, LoginModIdRequestS2CPayload> CODEC = new PacketCodec<PacketByteBuf, LoginModIdRequestS2CPayload>() {
        @Override
