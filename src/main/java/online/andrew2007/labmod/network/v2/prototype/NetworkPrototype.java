...
public class NetworkPrototype {
    ...
    public static final PacketType<NegotiationStartS2CPacket> NEGOTIATION_START_S2C = new PacketType<>(NetworkSide.CLIENTBOUND, Identifier.of("labmod", "negotiation_start_s2c"));
    public static final PacketType<NegotiationStartC2SPacket> NEGOTIATION_START_C2S = new PacketType<>(NetworkSide.SERVERBOUND, Identifier.of("labmod", "negotiation_start_c2s"));
}
